...
function Search({students}) {
  ...
  const [students,setVaule]=useState(students)
  console.log("Students list "+JSON.stringify(students))
  ...
  let nameSearch = () =>{
	...
	return (
		<div className="my-50 layout-row align-items-end justify-content-end">
			...
			<button type="button" data-testid="addBtn" onClick={nameSearch} className="small mb-0">Add</button>
		</div>
	);
}
